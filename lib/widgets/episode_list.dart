...
class EpisodeList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final episodeList = details.episodeList.map((ep) {
        ...
        builder: (context, watchedUrls, child) {
          return PreferenceBuilder(
            ...
            builder: (BuildContext context, _) {
              ...
              final double opacity = isWatched ? 0.6 : 1.0;
              final IconData icon = isWatched ? Icons.check : Icons.play_circle;
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          Theme.of(context).colorScheme.primary, // YANGILANDI
        ...
        children: [
          Align(
            ...
            child: IconButton(
              ...
              tooltip: 'Tartiblash', // foydalanuvchi uchun yordam
            ),
          ),
          ...episodeList,
        ],
